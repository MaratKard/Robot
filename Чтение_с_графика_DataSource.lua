...
function main()
    ...
    AddColumn(TableOFZ, 1, "�������", true, QTABLE_STRING_TYPE, 15)
    AddColumn(TableOFZ, 2, "���", true, QTABLE_INT_TYPE, 15)
    AddColumn(TableOFZ, 3, "�����", true, QTABLE_INT_TYPE, 15)
    AddColumn(TableOFZ, 4, "����", true, QTABLE_INT_TYPE, 15)
    AddColumn(TableOFZ, 5, "���", true, QTABLE_INT_TYPE, 15)
    AddColumn(TableOFZ, 6, "������", true, QTABLE_INT_TYPE, 15)
    AddColumn(TableOFZ, 7, "��������", true, QTABLE_INT_TYPE, 15)
    AddColumn(TableOFZ, 8, "��������", true, QTABLE_INT_TYPE, 15)
    AddColumn(TableOFZ, 9, "�������", true, QTABLE_INT_TYPE, 15)
    AddColumn(TableOFZ, 10, "��������", true, QTABLE_INT_TYPE, 15)
    AddColumn(TableOFZ, 11, "�����", true, QTABLE_INT_TYPE, 15)

    CreateWindow(TableOFZ)
    SetWindowCaption(TableOFZ, "������ � ������� ��� 26238 (60 ���.) - ����� DataSource")
